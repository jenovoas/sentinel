...
| `tools/quantum_scheduler.py` | Mismo | Duplicado obsoleto |
| `tools/quantum_scheduler_v2.py` | Mismo | Versión antigua |
| `quantum/quantum_scheduler_bridge.py` | FFI en `sentinel-cortex/src/lib.rs` | Bridge FFI para Python |

**Acción recomendada**:

- Eliminar `tools/quantum_scheduler.py` y `tools/quantum_scheduler_v2.py` (duplicados)
- Mantener `quantum_scheduler_bridge.py` como interfaz FFI si Python aún lo usa
...
**Acción recomendada**: Verificar si queda código Python que use la versión antigua.
...
- Duplicados de `quantum_scheduler.py` - **Eliminar**
...
## 🗑️ CÓDIGO DUPLICADO/RUPTURA (Eliminar)

| Archivo/Path | Problema | Acción |
|--------------|----------|--------|
| `./src/sentinel-cortex/` | Duplicación completa del crate | **ELIMINAR** - Usar `./sentinel-cortex/` |
| `core/cortex` | Symlink roto a `/home/jnovoas/dev/sentinel/sentinel-cortex` | **ELIMINAR** symlink |
| `tools/quantum_scheduler.py` | Duplicado de backend | **ELIMINAR** |
| `tools/quantum_scheduler_v2.py` | Versión antigua | **ELIMINAR** |
...
1. **Inmediato**: Eliminar código duplicado confirmado
