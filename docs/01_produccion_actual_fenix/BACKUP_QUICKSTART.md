...
- **Resumen para inversores**: [docs/BACKUP_SYSTEM_INVESTOR_SUMMARY.md](BACKUP_SYSTEM_INVESTOR_SUMMARY.md)
- **Plan de implementación**: [docs/BACKUP_REFACTORING_PLAN.md](BACKUP_REFACTORING_PLAN.md)
