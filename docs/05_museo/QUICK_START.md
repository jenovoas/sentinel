...
1. **Read HA docs**: [docs/HA_REFERENCE_DESIGN.md](../01_produccion_actual_fenix/HA_REFERENCE_DESIGN.md)
...
4. **Configure DNS failover**: See [docs/FAILOVER_ORCHESTRATION.md](../01_produccion_actual_fenix/FAILOVER_ORCHESTRATION.md)
