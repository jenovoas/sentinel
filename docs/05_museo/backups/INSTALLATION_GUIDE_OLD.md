...
Ver [HA_REFERENCE_DESIGN.md](../../01_produccion_actual_fenix/HA_REFERENCE_DESIGN.md) para detalles.
...
Ver [BACKUP_SETUP_GUIDE.md](../../01_produccion_actual_fenix/BACKUP_SETUP_GUIDE.md) para detalles.
...
- [README.md](../../07_prompts/README.md) - Descripción general del proyecto
- [ARCHITECTURE.md](../../00_fundamentos/ARCHITECTURE.md) - Arquitectura técnica
- [API Documentation](http://localhost:8000/docs) - Documentación de API
- [HA_REFERENCE_DESIGN.md](../../01_produccion_actual_fenix/HA_REFERENCE_DESIGN.md) - Alta disponibilidad
- [BACKUP_SETUP_GUIDE.md](../../01_produccion_actual_fenix/BACKUP_SETUP_GUIDE.md) - Sistema de backups
