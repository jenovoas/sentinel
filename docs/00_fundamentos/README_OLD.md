...
[![AI](https://img.shields.io/badge/AI-Local%20LLM-green)[~~docs/AI_INTEGRATION_COMPLETE.md(BROKEN)~~]
...
6. **💾 Enterprise Backup System**
   ...
   - [Learn more →](../07_prompts/README.md)
...
- [Architecture Deep-Dive](../01_produccion_actual_fenix/HA_REFERENCE_DESIGN.md)
- [Security Whitepaper[~~docs/SECURITY_WHITEPAPER.md(BROKEN)~~]
- [API Documentation](http://localhost:8000/docs)
- [Deployment Guide[~~docs/DEPLOYMENT.md(BROKEN)~~]

### Legal

- [Privacy Policy[~~PRIVACY.md(BROKEN)~~]
- [Terms of Service[~~TERMS.md(BROKEN)~~]
- [Security Policy](../06_traducciones/en/SECURITY.md)
- [License](LICENSE)
...
See [ROADMAP.md](../05_museo/ROADMAP.md) for detailed development timeline.
