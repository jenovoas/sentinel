...
## Architecture
See [ARCHITECTURE.md](../../../00_fundamentos/ARCHITECTURE.md) and [RESEARCH.md](../../../02_ciencia_y_quantum/RESEARCH.md).
```
...
Results from the experimental validation program ([RESEARCH.md](../../../02_ciencia_y_quantum/RESEARCH.md)):
...
→ **[RESEARCH.md](../../../02_ciencia_y_quantum/RESEARCH.md)** — methodology, results, open problems
...
See [CLAUDE.md[~~CLAUDE.md(BROKEN)~~] for build instructions and [ARCHITECTURE.md](../../../00_fundamentos/ARCHITECTURE.md) for system design.
...
Los experimentos están numerados en orden de concepción. EXP-023 (Detección de Deriva
Temporal), EXP-024 (Correlación Bio‑Sistema) y EXP-025 (Penta‑Resonancia) son parte del
registro de investigación que llevó al descubrimiento del ancla humana de 17 segundos.
