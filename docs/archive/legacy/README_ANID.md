...
1. **[CV_ANID.md](../../03_gobernanza/CV_ANID.md)** - CV del investigador responsable
2. **[ROADMAP.md](../../05_museo/ROADMAP.md)** - Alcance proyectado y fases de desarrollo
3. **[AIOPS_SHIELD.md[~~docs/AIOPS_SHIELD.md(BROKEN)~~]** - Defensa AIOpsDoom (innovación principal)
4. **[TRUTHSYNC_ARCHITECTURE.md[~~docs/TRUTHSYNC_ARCHITECTURE.md(BROKEN)~~]** - Arquitectura de verificación
5. **[CONTEXT_NOTE.md[~~CONTEXT_NOTE.md(BROKEN)~~]** - Enfoque técnico para evaluadores
...
- **[CV_ANID.md](../../03_gobernanza/CV_ANID.md)** - Perfil del investigador responsable
- **[ROADMAP.md](../../05_museo/ROADMAP.md)** - Visión técnica y fases de desarrollo
- **[FINAL_SUMMARY.md[~~FINAL_SUMMARY.md(BROKEN)~~]** - Resumen ejecutivo del proyecto
- **[VERIFICATION_REPORT.md](../../03_gobernanza/VERIFICATION_REPORT.md)** - Validación de integridad del sistema

### Documentación Técnica

- **[ARCHITECTURE.md](../../00_fundamentos/ARCHITECTURE.md)** - Arquitectura del dashboard
- **[AIOPS_SHIELD.md[~~docs/AIOPS_SHIELD.md(BROKEN)~~]** - Defensa AIOpsDoom
- **[TRUTHSYNC_ARCHITECTURE.md[~~docs/TRUTHSYNC_ARCHITECTURE.md(BROKEN)~~]** - Motor de verificación
- **[UML_DIAGRAMS_DETAILED_DESCRIPTIONS.md](../../00_fundamentos/UML_DIAGRAMS_DETAILED_DESCRIPTIONS.md)** - Diagramas técnicos
- **[MASTER_SECURITY_IP_CONSOLIDATION_v1.1_CORRECTED.md](../../03_gobernanza/MASTER_SECURITY_IP_CONSOLIDATION_v1.1_CORRECTED.md)** - Propiedad intelectual

### Guías de Instalación

- **[INSTALLATION_GUIDE.md](../../00_fundamentos/INSTALLATION_GUIDE.md)** - Instalación Linux
- **[INSTALLATION_GUIDE_WINDOWS.md](../../05_museo/INSTALLATION_GUIDE_WINDOWS.md)** - Instalación Windows
- **[QUICKSTART.md](../../05_museo/QUICKSTART.md)** - Inicio rápido
...
- [Installation Guide](../../00_fundamentos/INSTALLATION_GUIDE.md)
- [Architecture Overview](../../00_fundamentos/ARCHITECTURE.md)
- [Security Audit Report](../../03_gobernanza/SECURITY_AUDIT_REPORT.md)
- [AI Integration[~~docs/AI_INTEGRATION_COMPLETE.md(BROKEN)~~]
- [High Availability Setup](../../01_produccion_actual_fenix/HA_REFERENCE_DESIGN.md)
- **[📋 Project Roadmap](../../05_museo/ROADMAP.md)** - Alcance proyectado y visión técnica

---

## 🤝 Contributing

Contributions are welcome! Please read [CONTRIBUTING.md](../../00_fundamentos/CONTRIBUTING.md) for details.
